 ...
 * @see   WP_Widget
 */
class PLS_Price_Filter_List_Widget extends WP_Widget {
	...
	public function __construct() {
		$widget_ops  = array(
			'classname'   => 'pls_widget_price_filter_list widget_layered_nav',
			'description' => esc_html__( 'Shows a price filter list in a widget which lets you narrow down the list of shown products when viewing product categories.', 'pls-core' ),
		);
		$control_ops = array( 'width' => 400, 'height' => 350 );
		parent::__construct( 'pls-price-filter-list', esc_html__( 'PLS: Price Filter List', 'pls-core' ), $widget_ops, $control_ops );
	}
	...
	public function widget( $args, $instance ) {
		 ...
		 */
		$text = apply_filters( 'pls_widget_price_filter_list', $widget_text, $instance, $this );
	...
	public function form( $instance ) {
		...
		?>
		<p><label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e( 'Title:', 'pls-core' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
		</p>

		<p><label for="<?php echo esc_attr($this->get_field_id( 'text' )); ?>"><?php esc_html_e( 'Content:', 'pls-core' ); ?></label>
...
300|400'; ?></textarea>
		...
		<p><?php esc_html_e( 'Enter the price by format: min_price|max_price. Divide price list with linebreaks (Enter). Example:', 'pls-core' ); ?></p>
		<p><?php esc_html_e( '0|100', 'pls-core' ); ?><br><?php esc_html_e( '100|200', 'pls-core' ); ?><br><?php esc_html_e( '200|300', 'pls-core' ); ?>
			<br><?php esc_html_e( '300|400', 'pls-core' ); ?></p>
		<?php
	}
}
