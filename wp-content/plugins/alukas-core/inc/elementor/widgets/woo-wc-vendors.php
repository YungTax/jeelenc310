...
class PLS_Elementor_WCVendors extends PLS_Elementor_Widget_Base {
	/**
    ...
    public function get_title() {
        return esc_html__( 'WC Vendors', 'pls-core' );
    }
	...
	protected function render() {
		...
		$settings['id'] 		= pls_uniqid('pls-wc-vendors-');
		$class					= array( 'pls-element', 'pls-wc-vendors', 'pls-vendors-'.$style );
		...
		pls_core_get_templates( 'elements-widgets/wc-vendors/'.$style, $settings );
	}
}

$widgets_manager->register(new PLS_Elementor_WCVendors());