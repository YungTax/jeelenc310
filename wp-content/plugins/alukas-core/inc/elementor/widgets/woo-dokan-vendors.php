...
class PLS_Elementor_DokanVendors extends PLS_Elementor_Widget_Base {
	/**
    ...
    public function get_title() {
        return esc_html__( 'Dokan Vendors', 'pls-core' );
    }
    ...
    protected function register_controls() {
		...
		$this->add_control(
            ...
            [
                ...
                'type' 		=> Controls_Manager::SELECT,
                'options' 	=> [
					'meta_value'	=> esc_html__( 'Store Name', 'pls-core' ),
	...
	protected function render() {
		...
		$settings['id'] 		= pls_uniqid( 'pls-dokan-vendors-' );
		$class					= array( 'pls-element', 'pls-dokan-vendors', 'pls-vendors-'.$style );
		...
		pls_core_get_templates( 'elements-widgets/dokan-vendors/'.$style, $settings );
	}
}

$widgets_manager->register(new PLS_Elementor_DokanVendors());