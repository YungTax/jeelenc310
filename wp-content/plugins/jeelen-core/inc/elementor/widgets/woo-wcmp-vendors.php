...
class PLS_Elementor_WCMPVendors extends PLS_Elementor_Widget_Base {
	/**
    ...
    public function get_title() {
        return esc_html__( 'WCMP Vendors', 'pls-core' );
    }
	...
	protected function render() {
		...
		$settings['id'] 		= pls_uniqid('pls-wcmp-vendors-');
		$class					= array( 'pls-element', 'pls-wcmp-vendors', 'pls-vendors-'.$style );
		...
		pls_core_get_templates( 'elements-widgets/wcmp-vendors/'.$style, $settings );
	}
}

$widgets_manager->register(new PLS_Elementor_WCMPVendors());