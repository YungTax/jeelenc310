...
if ( ! class_exists( 'PLS_Core_Import' ) )
{
	class PLS_Core_Import {
		...
		function __construct() {
			...
			$sample_data = array(
				...
				'home-v1'		=> array(
					...
					'preview_demo_link' => 'https://jeelen.presslayouts.com',
				...
				'home-v2'		=> array(
					...
					'preview_demo_link' => 'https://jeelen.presslayouts.com/home-v2/?layout=v2',
					'widgets' 			=> 'widget_data.json',
					'theme_options' 	=> 'theme_options.json',
					'settings' 			=> array(
						'menu' 		=> $menu_locations,
				...
				'home-v3'		=> array(
					...
					'preview_demo_link' => 'https://jeelen.presslayouts.com/home-v3/?layout=v3',
					'widgets' 			=> 'widget_data.json',
				...
				'home-v4'		=> array(
					...
					'preview_demo_link' => 'https://jeelen.presslayouts.com/home-v4/?layout=v4',
					'widgets' 			=> 'widget_data.json',
					'theme_options' 	=> 'theme_options.json',
					'settings' 			=> array(
						'menu' 		=> $menu_locations,
				...
				'home-v5'		=> array(
					...
					'preview_demo_link' => 'https://jeelen.presslayouts.com/home-v5/?layout=v5',
					'widgets' 			=> 'widget_data.json',
				...
				'home-v6'		=> array(
					...
					'preview_demo_link' => 'https://jeelen.presslayouts.com/home-v6/?layout=v6',
					'widgets' 			=> 'widget_data.json',
				...
				'home-v7'		=> array(
					...
					'preview_demo_link' => 'https://jeelen.presslayouts.com/home-v7/?layout=v7',
					'widgets' 			=> 'widget_data.json',
				...
				'home-v8'		=> array(
					...
					'preview_demo_link' => 'https://jeelen.presslayouts.com/home-v8/?layout=v8',
					'widgets' 			=> 'widget_data.json',
				...
				'home-v9'		=> array(
					...
					'preview_demo_link' => 'https://jeelen.presslayouts.com/home-v9/?layout=v9',
					'widgets' 			=> 'widget_data.json',
					'theme_options' 	=> 'theme_options.json',
					'settings' 			=> array(
						'menu' 		=> $menu_locations,
				...
				'home-v10'		=> array(
					...
					'preview_demo_link' => 'https://jeelen.presslayouts.com/home-v10/?layout=v10',
					'widgets' 			=> 'widget_data.json',
					'theme_options' 	=> 'theme_options.json',
					'settings' 			=> array(
						'menu' 		=> $menu_locations,
				...
				'home-v11'		=> array(
					...
					'preview_demo_link' => 'https://jeelen.presslayouts.com/home-v11/?layout=v11',
					'widgets' 			=> 'widget_data.json',
					'theme_options' 	=> 'theme_options.json',
					'settings' 			=> array(
						'menu' 		=> $menu_locations,
				...
				'home-v12'		=> array(
					...
					'preview_demo_link' => 'https://jeelen.presslayouts.com/home-v12/?layout=v12',
					'widgets' 			=> 'widget_data.json',
				...
				'home-v13'		=> array(
					...
					'preview_demo_link' => 'https://jeelen.presslayouts.com/home-v13/?layout=v13',
					'widgets' 			=> 'widget_data.json',
				...
				'home-v14'		=> array(
					...
					'preview_demo_link' => 'https://jeelen.presslayouts.com/home-v14/?layout=v14',
					'widgets' 			=> 'widget_data.json',
					'theme_options' 	=> 'theme_options.json',
					'settings' 			=> array(
						'menu' 		=> $menu_locations,
		...
		public function import_config(){			
			...
			$from_url = 'https://jeelen.presslayouts.com/dummy';
