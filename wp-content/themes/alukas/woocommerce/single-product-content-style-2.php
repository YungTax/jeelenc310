<?php
/**
 * Single product content style 2 template
 *
 * @package pls
 */
...
<div class="pls-single-product-meta">
	<?php
	/**
	 * Hook: pls_woocommerce_single_product_meta.
	 *
	 * @hooked pls_single_product_breadcrumbs - 10
	 * @hooked pls_single_product_navigation - 20
	 */
	do_action( 'pls_woocommerce_single_product_meta' );
	?>
</div>