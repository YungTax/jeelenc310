...
update_option( 'jeelen_token_key', 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx' );
update_option( 'jeelen_is_activated', true );
update_option( 'jeelen_plugin_file', get_template_directory().'/plugins/' );
...
class PLS_Theme_Class {	
	...
	public  function constants() {
		...
		// Theme version
		define( 'PLS_THEME_NAME', 'jeelen' );
		define( 'PLS_THEME_SLUG', 'jeelen' );
