							...
							<?php
								echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
									...
									sprintf(
										...
										esc_attr( sprintf( __( 'Remove %s from cart', 'pls-theme' ), wp_strip_all_tags( $product_name ) ) ),
										esc_attr( $product_id ),
...
<?php else : ?>
	...
	<div class="woocommerce-mini-cart-empty">
		...
		<p class="woocommerce-mini-cart__empty-message"><?php echo apply_filters( 'pls_woocommerce_empty_mini_cart_message', esc_html__( 'Shopping cart is empty!', 'pls-theme' ) ); ?></p>	
